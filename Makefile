...
export TERRAFORM_PROVIDER_REPO ?= https://github.com/datastax/terraform-provider-astra
export TERRAFORM_PROVIDER_VERSION ?= 2.1.15
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-astra
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-astra_v2.1.15_x5
...
xpkg.build.provider-datastax-astra: do.build.images
